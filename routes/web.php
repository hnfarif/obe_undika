...
Route::prefix('penilaian')->name('penilaian.')->group(function (){
    ...
    Route::get('/clo/rangkuman-capaian-clo', [InstrumenNilaiController::class, 'rangkumanCapaianClo'])->name('rangkumCapaiClo')->middleware('ensureUserRole:p3ai,kaprodi,pimpinan,dekan');

    Route::get('/clo/rangkuman-capaian-clo/list', [InstrumenNilaiController::class, 'rangkumCapaiCloList'])->name('rangkumCapaiCloList')->middleware('ensureUserRole:p3ai,kaprodi,pimpinan,dekan');
