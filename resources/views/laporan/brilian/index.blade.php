                    ...
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a target="_blank"
                                    href="{{ route('laporan.brilian.exportPdf', ['pekan' => json_decode($pekan), 'rangBadge' => $rangBadge, 'rataFak' => $rataFak, 'rataProdi' => $rataProdi, 'indikator' => $indikator, 'data' => $data, 'dtlBri' => json_decode($dtlBri)]) }}"
