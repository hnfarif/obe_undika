        ...
        <div class="card-body">
            <form action="{{ route('peoplo.peo.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="" class="form-control  @error('desc_peo') is-invalid @enderror" name="desc_peo"
                        style="height: 100px" required>{{ old('desc_peo') }}</textarea>
                    @error('desc_peo')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
