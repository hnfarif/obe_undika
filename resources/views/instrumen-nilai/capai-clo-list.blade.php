                                    ...
                                    <table class="table table-striped" id="tableJdw">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ route('penilaian.detailInstrumen', ['nik' => $k->kary_nik, 'mkTdkLulus' => $mkTdkLulus->where('kary_nik', $k->kary_nik)->get()]) }}"
                                    ...
                                    <table class="table table-striped" id="tableTercapai">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a href="{{ route('penilaian.detailInstrumen', ['nik' => $k->kary_nik, 'mkLulus' => $mkLulus->where('kary_nik', $k->kary_nik)->get()]) }}"
                                                        class="btn btn-primary btn-sm text-sm">Detail</a>
                                                </td>
                                            </tr>
