        ...
        <section class="section">
            ...
            <div class="section-body">
                <div class="my-3 d-flex">
                    ...
                    <form class="card-header-form ml-3" action="{{ route('penilaian.clo.index') }}">
                    ...
                    <div class="col-12 col-md-12 col-lg-4">
                        <div
                            ...
                            <div class="card-footer">
                                <button data-mk="{{ $jdw->prodi.$jdw->klkl_id }}" class="btn @if ($instru->where('klkl_id', $jdw->klkl_id)->where('nik',$jdw->kary_nik)->first()) btn-primary @else btn-warning @endif btn-sm
